...
const Connextion: React.FC = () => {
	...
	return (
		// @ts-ignore
		<div className="conatiner-h text-center d-flex align-items-center justify-content-center min-vh-100">
						...
						<input
							...
							{...register('utilisateur', {
								...
								minLength: {
									value: 4,
									message:
										"La longueur doit être d'au moins 4",
								},
								pattern: {
									value: /^[A-Za-z]+$/i,
									message:
						...
						<input
							...
							{...register('MotDePasse', {
								...
								minLength: {
									value: 8,
									message:
										"La longueur doit être d'au moins 8",
								},
							})}
						/>
						{errors.MotDePasse && (
